...
<form name="createVmForm" action="newvm.jsp" method="post">
	<fieldset> 
		...
		<div class="clear"></div> 
		 <label for="scaleout">Scale Out:</label> 
		<select id="scaleout" name="scaleout">
			<option value="false" selected="selected">No Scale Out Machine</option>
			<option value="true">Machine With Scale Out</option>
		</select>
		<br /> 
