package  educloud.cloudserver.configuration;
...
public class ServerConfig {
	...
	private static String urlVirtualBox; 
	...
	public static void setup() throws InvalidConfigurationException {
		...
		urlVirtualBox = props.getProperty("storage.urlVirtualBox");
		storageName = props.getProperty("storage.storageName");
		pathTemplates = props.getProperty("storage.pathTemplates");
	...
	public static String getUrlVirtualBox() {
		return urlVirtualBox;
	}
