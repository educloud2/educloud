...
import  educloud.api.entities.User.UserType;
import  educloud.cloudserver.database.dao.SessionDao;
...
public class UserRest extends CloudResource {
	...
	public Response login(@QueryParam("login") String login, @QueryParam("pass") String pass) {
		...
		if (validUser) {
		 ...
		 educloud.api.entities.User extUser = new  educloud.api.entities.User();
	...
	public Response listUsers() {
		...
		List< educloud.api.entities.User> extUsers = new ArrayList< educloud.api.entities.User>();
	...
	public Response createUser(String jsonUser) {
		...
		if (cloudSession.getUser().getType() != User.UserType.ADMIN) {
		 ...
		 educloud.api.entities.User extUser = gson.fromJson(jsonUser,  educloud.api.entities.User.class);

		User user = new User();
		user.setLogin(extUser.getLogin());
		user.setName(extUser.getName());
		user.setType( educloud.cloudserver.entity.User.UserType.valueOf(extUser.getType().name()));
