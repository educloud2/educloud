package  educloud.cloudserver.launchers;
...
import  educloud.cloudserver.servlet.filter.RestSecurityFilter;
...
public class JettyLauncher {
	...
	public static void main(String[] args) {
		...
		sh.setInitParameter("com.sun.jersey.config.property.packages", " educloud.cloudserver.rs");
		...
		sh.setInitParameter("com.sun.jersey.config.property.resourceConfigClass", "com.sun.jersey.api.core.PackagesResourceConfig");
		sh.setInitParameter("com.sun.jersey.config.property.packages", " educloud.cloudserver.internalrs");
