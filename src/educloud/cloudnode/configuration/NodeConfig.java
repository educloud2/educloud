package  educloud.cloudnode.configuration;
...
public class NodeConfig {
	...
	private static String storageUser;
	
	private static String storagePass;
	...
	public static void setup() throws InvalidConfigurationException {
		...
		storageIp = props.getProperty("storage.ip");
		storageUser = props.getProperty("storage.user");
		storagePass = props.getProperty("storage.pass");
	...
	public static void setStorageIp(String storageIp) {
		NodeConfig.storageIp = storageIp;
	}
	...
	public static void setStorageUser(String storageUser) {
		NodeConfig.storageUser = storageUser;
	}
	...
	public static void setStoragePass(String storagePass) {
		NodeConfig.storagePass = storagePass;
	}
