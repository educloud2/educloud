...
public class EduCloudVMClient extends AbstractClient {
	...
	/**
	 * Change a virtual machine
	 *
	 * @param machine
	 * @throws EduCloudServerException
	 */
	public void changeVM(VirtualMachine machine) throws EduCloudServerException {
		WebResource service = getWebResouce();

		String json = gson.toJson(machine);

		ClientResponse response = service.path("vm").path("change").accept(MediaType.APPLICATION_JSON).put(ClientResponse.class, json);
	 ...
	 * @throws EduCloudServerException
	 */
	public void cloneVM(VirtualMachine machine) throws EduCloudServerException {
		WebResource service = getWebResouce();

		String json = gson.toJson(machine);

		ClientResponse response = service.path("vm").path("clone").accept(MediaType.APPLICATION_JSON).put(ClientResponse.class, json);
